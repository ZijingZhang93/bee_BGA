...
write.csv(sft$fitIndices,'../Plots/pickSoftThreshold.csv',row.names = FALSE)
# Plot the results:
pdf('../Plots/02pickSoftThreshold.pdf',width = 7,height = 4)
#sizeGrWindow(9, 5)
par(mfrow = c(1,2));
cex1 = 0.9;
...
# Plot the result
#pdf('../Plots/02Clustering_of_module_eigengenes.pdf',width = 7, height = 6)
sizeGrWindow(7, 6)
